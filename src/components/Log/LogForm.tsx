...
const LogForm = ({
  ...
  const [activityId, setActivityId] = useState(initialLog?.activityId ?? activities[0]?.id ?? '');
  const [timestamp, setTimestamp] = useState(
    initialLog ? toLocalInputValue(initialLog.timestamp) : nowInputValue(),
  );
